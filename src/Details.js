                ...
                <div className="row">
                    ...
                    <div style={{ height:"50vh" }} className="col-sm-5 card">
                        ...
                        <div className="card-body" style={{ overflowY: "scroll" }}>
                            ...
                            {
                                following?(
                                this.state.following.length ? (this.state.following.map((user, i) => <Card m={0} key={i} user={user}></Card>)) : null ):(<p className="lead text-dark text-center bg-warning">No Following</p>)
                            }
                        </div>
                    </div>
                </div>
